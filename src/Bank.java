...
public class Bank {
    //array list to hold account list
    ...
    //iterate through each account list type and return its values.
    public String iterateAndDisplayAccountList() {
    ...
    public String toString() {
        return iterateAndDisplayAccountList();
    }
}
